...
Overall, my experience working with Polyglot was positive - it wasn't always easy or straightforward to express my ideas into an implementation, but it was way better than having to write a compiler from scratch. If you want a broad overview of how to write Polyglot extensions, check out my [Guide to Writing Polyglot Extensions](https://yangdanny97.github.io/blog/2020/07/23/polyglot2).
